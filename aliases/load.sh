...
if [[ $(command -v az > /dev/null; echo $?) == 0 ]]; then
    ...
    alias azlogin_fy25="az login --tenant 43dc75e3-499a-40cd-891a-ba9f8e445365"
    alias azlogin_fy25dc="az login --tenant 43dc75e3-499a-40cd-891a-ba9f8e445365 --use-device-code"
fi
...
alias md2pdf="$DIR/mdpdf/convert.sh"